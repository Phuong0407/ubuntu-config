...
ls.add_snippets("tex", {
  ...
  s("part", {
    ...
    t("\\label{part:"),
    f(label, { 1 }), t("} % (fold)"),
    t({ "", "% part " }), f(title, { 1 }), t(" (end)"),
  }),
  s("cha", {
    t("\\chapter{"), i(1), t("}"),
    t("\\label{cha:"),
    f(label, { 1 }), t("} % (fold)"),
    t({ "", "% chapter " }), f(title, { 1 }), t(" (end)"),
  }),
  s("sec", {
    t("\\section{"), i(1), t("}"),
    t("\\label{sec:"),
    f(label, { 1 }), t("} % (fold)"),
    t({ "", "% section " }), f(title, { 1 }), t(" (end)"),
  }),
  s("sub", {
    t("\\subsection{"), i(1), t("}"),
    t("\\label{sub:"),
    f(label, { 1 }), t("} % (fold)"),
    t({ "", "% subsection " }), f(title, { 1 }), t(" (end)"),
  }),
  s("ssub", {
    t("\\subsubsection{"), i(1), t("}"),
    t("\\label{ssub:"),
    f(label, { 1 }), t("} % (fold)"),
    t({ "", "% subsubsection " }), f(title, { 1 }), t(" (end)"),
  }),
  ...
  s("ns-mom", {
    t("\\rho \\left( \\frac{\\partial \\mathbf{u}}{\\partial t} + (\\mathbf{u} \\cdot \\nabla) \\mathbf{u} \\right) = -\\nabla p + \\mu \\nabla^2 \\mathbf{u}"),
  }),
